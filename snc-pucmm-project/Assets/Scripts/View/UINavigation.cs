...
{
    class UINavigation : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            graph.Nodes.Add(new Node() { Name = "Ciencias Basicas I", Latitude = 19.442237f, Longitude = -70.683398f, Active = true });
            graph.Nodes.Add(new Node() { Name = "Ciencias Basicas II", Latitude = 19.442070f, Longitude = -70.683066f, Active = true });
            ...
            graph.Nodes.Add(new Node() { Name = "Lab. Generales de Ingeniería", Latitude = 19.441074f, Longitude = -70.682704f, Active = true });
            graph.Nodes.Add(new Node() { Name = "Matadero", Latitude = 19.440198f, Longitude = -70.683129f, Active = true });
            graph.Nodes.Add(new Node() { Name = "Talleres y Suministro", Latitude = 19.440616f, Longitude = -70.683350f, Active = true });
            graph.Nodes.Add(new Node() { Name = "Biblioteca", Latitude = 19.443727f, Longitude = -70.684183f, Active = true });
            graph.Nodes.Add(new Node() { Name = "Talleres Electromecánica", Latitude = 19.440273f, Longitude = -70.682706f, Active = true });
            ...
            graph.AddNeighbor("Node 1", "Matadero");
            ...
            graph.AddNeighbor("Node 6", "Talleres Electromecánica");
            graph.AddNeighbor("Node 6.5", "Talleres Electromecánica");
            ...
            graph.AddNeighbor("Node 9.5", "Talleres y Suministro");
            ...
            graph.AddNeighbor("Node 22", "Ciencias Basicas I");
            ...
            graph.AddNeighbor("Node 28", "Ciencias Basicas I");
            ...
            directions = (UIDirections)(GameObject.Find("GUI")).GetComponent("UIDirections");
            directions.PrintDirections(path);
        }

        void Update()
        {
            directions.UpdateColor();
        }
    }
}
